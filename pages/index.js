...
const Home = () => {
  ...
  const getJainAdvantage = async () => {
    try {
      const { data } = await axios.get(
        `${process.env.NEXT_PUBLIC_API}/get-edxplore-advantage`,
      )
  ...
  return (
    <>
     ...
     <hr className='hrx' />
                    ...
                    <div className='bform'>
                      <p className='headx'> EdXplore: India’s Leading Skilling Aggregator</p>
            ...
            <button type="submit">
              ...
              <div className='bannerimg'>
                <div className='col-md-6 col-lg-6'>
                  ...
                  <h1
                      className="bnrhd" >
                         <span style={{ color: "#fff" }}>Your gateway to a <br /></span>
                      Successful career
                      </h1>
              ...
              <div className="container">
                ...
                >
                     ...
                     <div className="team-boxed">
                        ...
                        <img src='./images/rating.png' style={{marginLeft:50}} />
